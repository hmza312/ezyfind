...
import { StyleSheet, TouchableOpacity, Text, View, TextInput,ScrollView ,Switch,Dimensions } from 'react-native';
import DropDownPicker from 'react-native-dropdown-picker';
import { Input, CheckBox, Button, SocialIcon } from 'react-native-elements';
import MapView from 'react-native-maps';
export default class RequesItem extends Component{
    constructor(props){
        super(props);
        this.state={
